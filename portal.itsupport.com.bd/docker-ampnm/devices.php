...
if (isset($_SESSION['success_message'])) {
    $message = '<div class="bg-green-500/20 border border-green-500/30 text-green-300 text-sm rounded-lg p-3 text-center mb-4">' . htmlspecialchars($_SESSION['success_message']) . '</div>';
    unset($_SESSION['success_message']);
}
if (isset($_SESSION['error_message'])) {
    $message = '<div class="bg-red-500/20 border border-red-500/30 text-red-300 text-sm rounded-lg p-3 text-center mb-4">' . htmlspecialchars($_SESSION['error_message']) . '</div>';
...
<main id="app">
    ...
    <!-- Device Details Modal (kept for viewing details, not editing) -->
