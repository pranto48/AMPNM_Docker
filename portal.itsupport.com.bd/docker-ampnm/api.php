...
$userActions = ['get_users', 'create_user', 'delete_user', 'get_profile', 'update_profile'];
...
$publicActions = ['check_device_status']; // NEW: Publicly accessible actions

// Check for public actions first, bypass auth_check.php
if (in_array($action, $publicActions)) {
    // For public actions, we only need config.php and functions.php
    require_once 'config.php';
    require_once 'includes/functions.php';
    require __DIR__ . '/api/handlers/public_api_handler.php';
} else {
    // For all other actions, authentication is required
    require_once 'includes/auth_check.php'; // This will handle session start and authentication
