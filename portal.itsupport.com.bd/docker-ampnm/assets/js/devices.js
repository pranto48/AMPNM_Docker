function initDevices() {
    ...
    const createDeviceBtn = document.getElementById('createDeviceBtn'); // This button is now a link in devices.php
    ...
    // Removed deviceModal and deviceForm elements as editing is now page-based
        ...
        return `
            <tr data-id="${device.id}" class="border-b border-slate-700 hover:bg-slate-800/50">
                ...
                <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                    ...
                    ${viewOnMapLink}
                    <a href="edit_device.php?id=${device.id}" class="edit-device-btn text-yellow-400 hover:text-yellow-300 mr-3" data-id="${device.id}" title="Edit Device"><i class="fas fa-edit"></i></a>
    ...
    // Removed populateMapSelector and openDeviceModal as they are now handled by add_device.php and edit_device.php
    ...
    // Removed createDeviceBtn.addEventListener('click') as it's now a direct link
    // Removed cancelBtn.addEventListener('click') as the modal is gone
